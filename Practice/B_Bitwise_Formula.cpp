...
int32_t main() {
    ...
    rep(test_case, 1, tc+1) {
        ...
        map<string, pair<string, string>> xors, ors, ands;
        rep(i, 0, n) {
            string te1, te2, te3;
            cin>>te1>>te2>>te3;

            if(te3 == "?" || (te3[0] >= 'a' && te3[0] <= z)) {
                string te4, te5;
                cin>>te4>>te5;

                if(te4 == "AND") ands.insert({te1, {te3, te5}});
                else if(te4 == "OR") ors.insert({te1, {te3, te5}});
                else xors.insert({te1, {te3, te5}});
            } else {
                vars.insert({te1, te3});
            }
        }
