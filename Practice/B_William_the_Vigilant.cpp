...
bool check(int n, string &s, int idx) {
    if(idx > 0 && idx < n-1 && s[idx-1] == 'a' && s[idx] == 'b' && s[idx+1] == 'c') return 1;
    if(idx < n-2 && s[idx] == 'a' && s[idx+1] == 'b' && s[idx+2] == 'c') return 1;
    if(idx > 1 && s[idx-2] == 'a' && s[idx-1] == 'b' && s[idx] == 'c') return 1;
